...
export class PublicSiteApiService {
  ...
  createNewPatientUser(patientUserRequestBody: any): Observable<any> {
    return this.http.post<any>(`${this.apiEndPoint}/api/v1/self-registration`, patientUserRequestBody);
  }
